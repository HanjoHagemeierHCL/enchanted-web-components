...
import { ENCHANTED_CHIP_TAG } from '../components/tags';
    ...
    return html`
      <div style="display: flex; flex-direction: column; gap: 20px;">
        ...
        <div>
          ...
          <div style="display: flex; gap: 10px; flex-wrap: wrap; align-items: center;">
            <${ENCHANTED_CHIP_TAG} .name=${'Avatar Chip'} .icon=${html`<icon-checkmark size='16'></icon-checkmark>`} ?showAvatar=${true}></${ENCHANTED_CHIP_TAG}>
            <${ENCHANTED_CHIP_TAG} .name=${'Avatar + Count'} .count=${12} .icon=${html`<icon-checkmark size='16'></icon-checkmark>`} ?showAvatar=${true} ?showChipCount=${true}></${ENCHANTED_CHIP_TAG}>
          </div>
        </div>
        ...
        <div>
          ...
          <div style="display: flex; gap: 10px; flex-wrap: wrap; align-items: center;">
            ...
            <${ENCHANTED_CHIP_TAG} .name=${'Clear + Avatar'} ?clearIcon=${true} .icon=${html`<icon-checkmark size='16'></icon-checkmark>`} ?showAvatar=${true}>
              <div slot="clear-icon"><icon-close size='16'></icon-close></div>
            </${ENCHANTED_CHIP_TAG}>
          </div>
        </div>
        ...
        <div>
          ...
          <div style="display: flex; gap: 10px; flex-wrap: wrap; align-items: center;">
            <${ENCHANTED_CHIP_TAG} .name=${'Full Featured'} .count=${25} .icon=${html`<icon-checkmark size='16'></icon-checkmark>`} ?showAvatar=${true} ?showChipCount=${true} ?clearIcon=${true}>
              <div slot="clear-icon"><icon-close size='16'></icon-close></div>
            </${ENCHANTED_CHIP_TAG}>
          </div>
        </div>
        ...
        <div>
          ...
          <div style="display: flex; gap: 10px; flex-wrap: wrap; align-items: center;">
            ...
            <${ENCHANTED_CHIP_TAG} .name=${'Disabled + Avatar'} .icon=${html`<icon-checkmark size='16'></icon-checkmark>`} ?disabled=${true} ?showAvatar=${true}></${ENCHANTED_CHIP_TAG}>
